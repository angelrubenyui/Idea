...
namespace Idea.Common.Validation
{
    ...
    public class NIFValidation
    {
        ...
        /// </summary>
        public string TipoNifDescripcion { get { return tipo.ToString(); } }

        public TiposCodigosEnum TipoNif
        {
            get { return tipo; }
        }
        ...
        private NIFValidation(string numero)
        {
        ...
        /// </returns>
        public static NIFValidation CheckNif(string numero)
        {
            return new NIFValidation(numero);
        }
